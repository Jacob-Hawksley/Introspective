...
func cutscene(delta):
	...
	$Sprite2D.play("open")
	$Interactions/classdoor/AnimatedSprite2D.global_position = $Interactions/classdoor/CollisionShape2D.global_position
	$Interactions/classdoor/AnimatedSprite2D.visible = true
func _ready() -> void:
